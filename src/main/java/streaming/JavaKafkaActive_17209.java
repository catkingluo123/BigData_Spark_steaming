 ...
 */
public class JavaKafkaActive_17209 {

    private static final Logger logger = Logger.getLogger(JavaKafkaActive_17209.class);

    private static final Pattern SPACE = Pattern.compile("\\|");

    private static final String Redis_Hss = "hss_data";

    private static final String Redis_Itc = "relate_17209_";
