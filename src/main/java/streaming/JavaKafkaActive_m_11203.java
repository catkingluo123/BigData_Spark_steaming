 ...
 */
public class JavaKafkaActive_m_11203 {

    private static final Logger logger = Logger.getLogger(JavaKafkaActive_m_11203.class);

    private static final Pattern SPACE = Pattern.compile("\\|");

    private static final String Redis_Hss = "hss_data";

    private static final String Redis_Itc = "core_11201_";//接口定义

    public static void main(String[] args)  {
        if (args.length < 4) {
            System.err.println("Usage: JavaKafkaActive_m_11203 <zkQuorum> <group> <topics> <numThreads>");
            System.exit(1);
        }

        SparkConf sparkConf = new SparkConf().setAppName("JavaKafkaActive_m_11203");
