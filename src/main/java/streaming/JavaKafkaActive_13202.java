 ...
 */
public class JavaKafkaActive_13202 {

    private static final Logger logger = Logger.getLogger(JavaKafkaActive_13202.class);

    private static final Pattern SPACE = Pattern.compile("\\|");

    private static final String Redis_Itc = "online_13202_";//接口定义

    public static void main(String[] args)  {
        if (args.length < 4) {
            System.err.println("Usage: JavaKafkaActive_13202 <zkQuorum> <group> <topics> <numThreads>");
            System.exit(1);
        }

        SparkConf sparkConf = new SparkConf().setAppName("JavaKafkaActive_13202");
